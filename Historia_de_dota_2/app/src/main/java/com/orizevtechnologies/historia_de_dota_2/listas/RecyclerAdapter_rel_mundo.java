...
public class RecyclerAdapter_rel_mundo extends RecyclerView.Adapter<RecyclerAdapter_rel_mundo.RecyclerHolderRel_Mundo>{

    private List<lista_relacionados> items_relacionados;
    private List<lista_relacionados> original_items_relacionados;
    private RecyclerAdapter_rel_mundo.RecyclerItemClick_mundo itemClick_relacionados;


    public RecyclerAdapter_rel_mundo(List<lista_relacionados> items_relacionados, RecyclerItemClick_mundo itemClick_relacionados) {
    ...
    @NonNull
    @Override
    public RecyclerHolderRel_Mundo onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.lista_relacionados, parent, false);
        return new RecyclerHolderRel_Mundo(view);

    }


    @Override
    public void onBindViewHolder(@NonNull RecyclerHolderRel_Mundo holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                itemClick_relacionados.itemClick_Mundo(listaRelacionados);
            }
        });
    }
    ...
    public static class RecyclerHolderRel_Mundo extends RecyclerView.ViewHolder {

        private ImageView img_pr;
        private TextView nombre_pr;
        private TextView nombre_sc;

        public RecyclerHolderRel_Mundo(@NonNull View itemView_4) {
            super(itemView_4);
    ...
    public interface RecyclerItemClick_mundo {
        void itemClick_Mundo(lista_relacionados item);
    }
